...
const dungeonList = [
  ...
  { name: "collusseum", emoji: "🏟️", background: "#1b2b3a" },
...
for (let i = 0; i < dungeonList.length; i++) {
  ...
  if (i === 0) {
    ...
    const raw = {
      floorBase: prev.floorBase * 1.152 + 2.8 + prev.floorMult * prev.floorAmount * 1.092,
      floorMult: (prev.floorMult + 0.000055) * 1.009,
