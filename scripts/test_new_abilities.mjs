...
console.log(
  "DoT Applied:",
  target.effects.some((e) => e.type === "dot")
);
...
console.log(
  "HoT Applied:",
  target.effects.some((e) => e.type === "hot")
);
console.log("Target effects:", target.effects);
...
console.log(
  "Weaken Applied:",
  target.effects.some((e) => e.type === "weaken")
);
...
const vulnAbility = {
  ...
  effects: [{ type: "vulnerability", amount: 0.3, duration: 3 }],
  skillId: "skill_witchcraft",
};
buffEngine.applyEffect(caster, target, vulnAbility);
console.log(
  "Vulnerability Applied:",
  target.effects.some((e) => e.type === "vulnerability")
);
...
console.log(
  "Defense-Down Applied:",
  target.effects.some((e) => e.type === "defenseDown")
);
